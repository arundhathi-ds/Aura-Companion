...
export const CATEGORIES: CategoryProfile[] = [
  // FOCUS & PRODUCTIVITY
  {
    ...
    audioTargets: { energy: 0.22, valence: 0.1, danceability: 0.05, acousticness: 0.35, instrumentalness: 0.75, tempo: 60 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.32, valence: 0.28, danceability: 0.1, acousticness: 0.48, instrumentalness: 0.65, tempo: 75 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.42, valence: 0.22, danceability: 0.25, acousticness: 0.12, instrumentalness: 0.72, tempo: 95 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.15, valence: 0.12, danceability: 0.02, acousticness: 0.62, instrumentalness: 0.85, tempo: 50 },
  ...
  // EMOTIONAL ATMOSPHERES
  {
    ...
    seed_artists: ['Bon Iver', 'Damien Rice', 'Nora Jones', 'The Tallest Man on Earth', 'Novo Amor'],
    audioTargets: { energy: 0.28, valence: 0.35, danceability: 0.12, acousticness: 0.62, instrumentalness: 0.4, tempo: 65 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.45, valence: 0.42, danceability: 0.32, acousticness: 0.28, instrumentalness: 0.08, tempo: 88 },
  ...
  },
  {
    ...
    seed_artists: ['Sigur Rós', 'Godspeed You! Black Emperor', 'Low Roar', 'Nick Drake', 'Elliott Smith'],
    audioTargets: { energy: 0.25, valence: 0.18, danceability: 0.08, acousticness: 0.35, instrumentalness: 0.52, tempo: 70 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.32, valence: 0.25, danceability: 0.15, acousticness: 0.5, instrumentalness: 0.15, tempo: 72 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.35, valence: 0.38, danceability: 0.22, acousticness: 0.32, instrumentalness: 0.28, tempo: 78 },
  ...
  // ATMOSPHERIC
  {
    ...
    audioTargets: { energy: 0.2, valence: 0.18, danceability: 0.06, acousticness: 0.55, instrumentalness: 0.68, tempo: 62 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.72, valence: 0.44, danceability: 0.62, acousticness: 0.01, instrumentalness: 0.35, tempo: 115 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.26, valence: 0.2, danceability: 0.05, acousticness: 0.08, instrumentalness: 0.92, tempo: 55 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.34, valence: 0.42, danceability: 0.18, acousticness: 0.68, instrumentalness: 0.35, tempo: 85 },
  ...
  },
  {
    ...
    seed_artists: ['Sturgill Simpson', 'Jason Isbell', 'Tyler Childers', 'Colter Wall', 'Whiskey Myers'],
    audioTargets: { energy: 0.48, valence: 0.45, danceability: 0.28, acousticness: 0.62, instrumentalness: 0.12, tempo: 92 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.18, valence: 0.24, danceability: 0.02, acousticness: 0.72, instrumentalness: 0.8, tempo: 58 },
  ...
  // ENERGY
  {
    ...
    audioTargets: { energy: 0.96, valence: 0.62, danceability: 0.88, acousticness: 0.0, instrumentalness: 0.08, tempo: 145 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.88, valence: 0.55, danceability: 0.78, acousticness: 0.02, instrumentalness: 0.1, tempo: 130 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.68, valence: 0.48, danceability: 0.68, acousticness: 0.05, instrumentalness: 0.2, tempo: 118 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.72, valence: 0.68, danceability: 0.62, acousticness: 0.15, instrumentalness: 0.22, tempo: 108 },
  ...
  // SOCIAL
  {
    ...
    seed_artists: ['The Strokes', 'Kings of Leon', 'Arctic Monkeys', 'Jack White', 'The Black Keys'],
    audioTargets: { energy: 0.68, valence: 0.58, danceability: 0.55, acousticness: 0.22, instrumentalness: 0.08, tempo: 105 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.85, valence: 0.72, danceability: 0.82, acousticness: 0.1, instrumentalness: 0.12, tempo: 125 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.48, valence: 0.55, danceability: 0.45, acousticness: 0.35, instrumentalness: 0.18, tempo: 92 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.32, valence: 0.58, danceability: 0.42, acousticness: 0.48, instrumentalness: 0.08, tempo: 88 },
  ...
  // CINEMATIC
  {
    ...
    seed_artists: ['Hans Zimmer', 'Trent Reznor', 'Hildur Guðnadóttir', 'John Williams', 'Thomas Newman'],
    audioTargets: { energy: 0.42, valence: 0.45, danceability: 0.12, acousticness: 0.28, instrumentalness: 0.78, tempo: 85 },
  ...
  },
  {
    ...
    seed_artists: ['Tyler, The Creator', 'Kendrick Lamar', 'Childish Gambino', 'James Blake', 'Radiohead'],
    audioTargets: { energy: 0.62, valence: 0.52, danceability: 0.48, acousticness: 0.12, instrumentalness: 0.25, tempo: 102 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.75, valence: 0.35, danceability: 0.55, acousticness: 0.02, instrumentalness: 0.4, tempo: 112 },
  ...
  },
  {
    ...
    audioTargets: { energy: 0.28, valence: 0.38, danceability: 0.18, acousticness: 0.32, instrumentalness: 0.38, tempo: 75 },
  ...
  // ORIGINAL CATEGORIES (kept for compatibility)
  {
    ...
    audioTargets: { energy: 0.35, valence: 0.42, danceability: 0.25, acousticness: 0.3, instrumentalness: 0.25, tempo: 82 },
...
export function pickCategoryForIntentWeather(intent: string, weather?: string): string {
  // Enhanced heuristics to map intent+weather to category key.
  const i = intent?.toLowerCase() ?? '';
  const w = weather?.toLowerCase() ?? '';

  // Focus/Productivity intents
  if (i.includes('focus') || i.includes('work') || i.includes('study')) {
    ...
    return Math.random() > 0.5 ? 'deep-focus' : 'study-flow';
  }

  // Energy/Activity intents
  if (i.includes('work') || i.includes('gym') || i.includes('exercise')) {
    if (w.includes('morning')) return 'morning-momentum';
    if (w.includes('night')) return 'late-night-energy';
    return Math.random() > 0.5 ? 'hyper-mode' : 'gym-beast';
  }

  // Emotional intents
  if (i.includes('heal') || i.includes('calm')) return 'healing';
  if (i.includes('sad') || i.includes('alone')) return Math.random() > 0.5 ? 'lonely-night' : 'overthinking-hours';
  ...
  if (i.includes('emotional') || i.includes('feel')) return 'nostalgia';
  ...
  if (i.includes('train') || i.includes('travel') || i.includes('adventure')) return 'midnight-train';
  ...
  // Cinematic intents
  if (i.includes('epic') || i.includes('hero') || i.includes('main character')) return 'main-character-walk';
