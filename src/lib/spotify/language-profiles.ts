...
export const LANGUAGE_PROFILES: Record<LanguageCode, LanguageProfile> = {
  ...
  ta: {
    ...
    emotionalNotes:
      'Tamil music carries old cinema magic and modern indie rebellion.',
    searchMarket: 'IN',
    audioModifiers: {
      valenceOffset: 0.05,
  ...
  hi: {
    ...
    emotionalNotes:
      'Hindi music dances between Bollywood romance and urban rebellion.',
    searchMarket: 'IN',
    audioModifiers: {
      valenceOffset: 0.1,
    },
  ...
  te: {
    ...
    emotionalNotes:
      'Telugu music pulses with vibrant energy and classical undertones.',
    searchMarket: 'IN',
    audioModifiers: {
      energyOffset: 0.08,
      valenceOffset: 0.08,
  ...
  ko: {
    ...
    emotionalNotes:
      'Korean music blends meticulous production with raw emotional truth.',
    searchMarket: 'KR',
    audioModifiers: {
      valenceOffset: 0.05,
      acousticnessOffset: -0.1,
  ...
  ja: {
    ...
    emotionalNotes:
      'Japanese music whispers elegance and melancholic beauty through silence.',
    searchMarket: 'JP',
    audioModifiers: {
      energyOffset: -0.05,
      valenceOffset: 0.02,
  ...
  ar: {
    ...
    emotionalNotes:
      'Arabic music wraps emotions in lyrical poetry and ancient resonance.',
    searchMarket: 'AE',
    audioModifiers: {
  ...
  es: {
    ...
    emotionalNotes:
      'Spanish music dances between fire and tenderness, always alive.',
    searchMarket: 'MX',
    audioModifiers: {
      energyOffset: 0.12,
  ...
  pt: {
    ...
    emotionalNotes:
      'Brazilian music breathes movement and soul into every moment.',
    searchMarket: 'BR',
    audioModifiers: {
  ...
  en: {
    ...
    emotionalNotes:
      'English music speaks the unspeakable with poetic clarity.',
    searchMarket: 'US',
    audioModifiers: {},
  },
};
